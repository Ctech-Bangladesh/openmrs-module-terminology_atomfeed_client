...
public class ConceptFeedWorker implements EventWorker {
    ...
    public ConceptFeedWorker(AuthenticatedHttpClient httpClient, TRFeedProperties properties, ConceptService conceptService, Mapper<Concept> conceptMapper, ConceptPostProcessor postProcessor) {
